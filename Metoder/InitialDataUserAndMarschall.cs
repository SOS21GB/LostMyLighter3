...
namespace LighterGrp3.Metoder
{
    public class InitialDataUserAndMarschall
    {
        ...
        public static void InitialData()
        {
            ...
            Marshall marshall1 = new Marshall( 10, "märke1", 10000, true, dt, "Sveagatan 2", "12345", 100);
            Marshall marshall2 = new Marshall( 20, "märke2", 20000, true, dt, "Sveagatan 4", "23456", 200);
            Marshall marshall3 = new Marshall( 30, "märke3", 30000, true, dt, "Sveagatan 1", "34567", 300);
            Marshall marshall4 = new Marshall( 40, "märke4", 40000, true, dt, "Sveagatan 3", "45678", 400);
            Marshall marshall5 = new Marshall( 10, "märke1", 10000, true, dt, "Sveagatan 2", "12345", 100);
        }
